...
cp -f __test__/params-arrival-10-15.py params.py && \
...
cp -f __test__/params-arrival-15-20.py params.py && \
...
cp -f __test__/params-arrival-20-25.py params.py && \
...
cp -f __test__/params-arrival-25-30.py params.py && \
...
cp -f __test__/params-arrival-30-35.py params.py && \
...
cp -f __test__/params-arrival-35-40.py params.py && \
