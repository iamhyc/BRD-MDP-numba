...
#                         --inject 'PROC_MIN=int(0.25*N_SLT); PROC_MAX=int(0.50*N_SLT); proc_mean=genProcessingParameter(es2ap_map,True)'"
...
#                         --inject 'PROC_MIN=int(0.50*N_SLT); PROC_MAX=int(0.75*N_SLT); proc_mean=genProcessingParameter(es2ap_map,True)'"
